...
func (fake *Signer) Vrf(arg1 []byte) ([]byte, []byte, error) {
	var arg1Copy []byte
	if arg1 != nil {
		arg1Copy = make([]byte, len(arg1))
		copy(arg1Copy, arg1)
...
func (fake *Signer) VrfCallCount() int {
	fake.vrfMutex.RLock()
	defer fake.vrfMutex.RUnlock()
	return len(fake.vrfArgsForCall)
}

func (fake *Signer) VrfCalls(stub func([]byte) ([]byte, []byte, error)) {
	fake.vrfMutex.Lock()
	defer fake.vrfMutex.Unlock()
	fake.VrfStub = stub
}

func (fake *Signer) VrfArgsForCall(i int) []byte {
	fake.vrfMutex.RLock()
	defer fake.vrfMutex.RUnlock()
...
func (fake *Signer) VrfReturns(result1 []byte, result2 []byte, result3 error) {
	fake.vrfMutex.Lock()
	defer fake.vrfMutex.Unlock()
	fake.VrfStub = nil
...
func (fake *Signer) VrfReturnsOnCall(i int, result1 []byte, result2 []byte, result3 error) {
	fake.vrfMutex.Lock()
	defer fake.vrfMutex.Unlock()
	fake.VrfStub = nil
