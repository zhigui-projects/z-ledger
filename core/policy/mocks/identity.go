...
// VrfVerify provides a mock function with given fields: msg, rand, proof
func (_m *Identity) VrfVerify(msg []byte, rand []byte, proof []byte) bool {
	ret := _m.Called(msg, rand, proof)

	var r0 bool
	if rf, ok := ret.Get(0).(func([]byte, []byte, []byte) bool); ok {
		r0 = rf(msg, rand, proof)
	} else {
		r0 = ret.Get(0).(bool)
	}
