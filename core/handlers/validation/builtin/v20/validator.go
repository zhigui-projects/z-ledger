...
type StateBasedValidator interface {
	...
	// parametres
	Validate(cc string, blockNum, txNum uint64, rwset, prp, ep, chdr []byte, endorsements []*peer.Endorsement, vrfs []*utils.VrfEndorsement) commonerrors.TxValidationError
